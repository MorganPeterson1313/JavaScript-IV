...
class GameObject {
    ...
    this.dimensions = attributes.dimenstions;
    }
       destroy() {
    ...
    */
    ...
    this.weapon = attributes.weapons;
     ...
     pulverize(target){
        ...
        return `Finish ${villain.name}! Take that ${villain.name}! Now you are destroyed by ${hero.weapons}!`;
    ...
    this.weapons = attributes.weapons;
        ...
        pulverize (target){
            ...
            if(target.healthPoints <= 2){
                return `Finish ${hero.name}! Take that ${hero.name}! Now you are destroyed by my ${villain.weapons}!`;
            }else if (this.healthPoints <= 0) {
              return `${this.name} you're destroyed`;
            } else {
             return target.name; 
